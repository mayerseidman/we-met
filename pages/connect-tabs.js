...
// ══════════════════════════════════════════════════════════════
// Main connect page with scan and show QR tabs
...
export default function ConnectPage() {
    ...
    return (
        <div className={styles.page}> {/* ADD THIS WRAPPER */}
            <Header />
            <TabBar activeTab={activeTab} onSelect={setActiveTab} tabs={TABS} /> {/* ADD tabs={TABS} */}
